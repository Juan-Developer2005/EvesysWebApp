...
namespace EvesysWebApp.Controllers
{
    ...
    public class ProductosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProductoId,Nombre,Precio,Descripcion")] Producto producto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProductoId,Nombre,Precio,Descripcion")] Producto producto)
        {
